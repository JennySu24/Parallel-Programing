...
//nvcc -std=c++17 correctness_guess.cpp train.cpp guessing.cu md5.cpp -o main
//nvcc -std=c++17 correctness_guess.cpp train.cpp guessing.cpp guessing_kernel.cu md5.cpp -o main
int main()
{
